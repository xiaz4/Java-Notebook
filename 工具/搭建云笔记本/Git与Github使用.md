...
![image-20200830010732640](Git与Github使用.image/image-20200830010732640.png)

如下图会弹出一个对话框，在URL输入项目地址，选择好我们想将项目存放在本机的位置，点击Clone按钮即可，可以进入我们本机的下载地址看到已经成功

也可通过登录Github官网，直接拉取工程

![image-20200830010352246](Git与Github使用.image/image-20200830010352246.png)
